...
public class MessageVO {
	...
	public MessageVO(int msg_no, int msg_cate_no, String msg_target_id, String admin_id, String mem_id, String msg_cont,
			String msg_snd_date, String msg_rcv_date, int lang_major, int lang_itrst) {
		this.msg_no = msg_no;
		this.msg_cate_no = msg_cate_no;
		this.msg_target_id = msg_target_id;
		this.admin_id = admin_id;
